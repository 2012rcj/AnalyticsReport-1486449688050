...
<title>Consolidated Report Quarterly</title>
</head>
				...
				try {
					...
					ResultSet RS = stm.executeQuery(
							"select prod_nm,prod_id,qty,(round(total,2)) from retail_str_sales_detail where store_id='"
									+ EStid
									+ "' and sale_date Between ((select current_date from sysibm.sysdummy1)-120) and  (select current_date from sysibm.sysdummy1)");
		%>
		<table align="right">
			<tr>
				<td>
    ...
    <th>Monthly Average Sales/Day (In LKR) </th>-->
					...
					<%
						try {
									...
									FileOutputStream fileOut = new FileOutputStream("PDF/Abhi.xls");
