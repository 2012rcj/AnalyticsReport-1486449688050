...
ResultSet RS = stm.executeQuery("select distinct(retail_str_sales_detail.prod_nm),retail_str_sales_detail.qty,retail_str_sales_detail.mrp,retail_str_sales_detail.total,retail_store_prod.th_class_1,retail_store_prod.th_class_2,retail_store_prod.th_class_3,retail_store_prod.th_class_4,retail_store_prod.mfg from retail_str_sales_detail join retail_store_prod on retail_str_sales_detail.prod_nm=retail_store_prod.prod_nm where retail_str_sales_detail.store_id = "+EStid+" and retail_str_sales_detail.tri_id= "+tid+" ");
