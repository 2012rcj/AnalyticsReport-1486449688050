...
<html>
    ...
    <body>
        <form name="stridpage" ID="" method="POST">
            ...
            <%
                String selecteddate = (String) request.getParameter("Value1");
                request.getSession().setAttribute("seldate", selecteddate);
                String saledate = (String) session.getAttribute("seldate");
                ...
                if ((EStid != null)) {
                    try {
                        ...
                        ResultSet RS = stm.executeQuery(
                                "select tri_id,round(sum(total),2) from retail_str_sales_detail where store_id='" + EStid
                                + "' and sale_date =" + selecteddate + "  group by tri_id order by tri_id");
            %>
            <table align="right">
                <tr>
                    <td>
            ...
            <table style="white-space: nowrap;" border="1" align="center"
                ...
                <tr class="odd">
                    <td align="left"><a
                            href="Admin_Billwiseproduct.jsp?Value1='<%=(RS.getString(1))%>' "
                            style="color: #00FFF" style="text-decoration: none"><%=(RS.getString(1))%></td>
                ...
                <%
                    ...
                    try {
                        ...
                        ResultSet RS1 = stm.executeQuery(
                                "select tri_id,round(sum(total),2) from retail_str_sales_detail where store_id='"
                                + EStid + "' and sale_date =" + selecteddate
                                + "  group by tri_id order by tri_id");
            ...
            <%
                try {
                    ...
                    cell2.setCellValue("Total Sale   (In LKR)");
                    int b = 1;
                    {
                        while (RS1.next()) {
