...
<html>
    <head>
        ...
        <body>
            <form action="Admin_hemassalesdaily.jsp" method="post" id="myForm">
            ...
            //ResultSet rs2=stm.executeQuery("Select retail_str_sales_detail.sale_date,round(sum(retail_str_sales_detail.total),2)from retail_dstr_prod,retail_str_sales_detail where retail_str_sales_detail.store_id='"+EStid+"' and  retail_dstr_prod.prod_id=retail_str_sales_detail.prod_id and  SALE_DATE Between ( current_date + 1 days - day(current_date) days )and(select current_date from sysibm.sysdummy1) order by sale_date desc");
                ...
                <table style="white-space: nowrap;" border="1" align="center" id="tablepaging">
                    <tr class="even">
                        <th >Sales Date</th>
                        <th >Hemas Sales Value &nbsp&nbsp(In LKR)</th>
                  ...
                  //Image image1 = Image.getInstance("/home/rspl-laxmeechandola/NetBeansProjects/99AR_dashdb/web/PDF/logo.jpg");
                    ...
                    <tr class="odd">
                        ...
                        <td align="left"><a href="Admin_hemassalesdaydetail.jsp?Value1='<%=(RS.getString(1))%>' "style="color:#00FFF" style="text-decoration: none" ><%=(RS.getString(1))%></a></td>
                        ...
                        //out.println(abc);
                            ...
                            try {
                                ...
                                ResultSet RS2 = stmt.executeQuery("select retail_str_sales_detail.sale_date,round(sum(retail_str_sales_detail.total),2) from retail_dstr_prod,retail_str_sales_detail where retail_dstr_prod.prod_id=retail_str_sales_detail.prod_id and retail_str_sales_detail.store_id='" + EStid + "' and  retail_str_sales_detail.sale_date between '" + date1 + "' and '" + date2 + "'  group by retail_str_sales_detail.sale_date order by retail_str_sales_detail.sale_date desc");
                                while (RS2.next()) {
                                    a[i] = RS2.getString(2);
                                    i++;
                                }
...
%>
                    ...
                    <% }
                            ...
                            ResultSet RS1 = stm.executeQuery("select retail_str_sales_detail.sale_date,round(sum(retail_str_sales_detail.total),2) from retail_dstr_prod,retail_str_sales_detail where retail_dstr_prod.prod_id=retail_str_sales_detail.prod_id and retail_str_sales_detail.store_id='" + EStid + "' and  retail_str_sales_detail.sale_date between '" + date1 + "' and '" + date2 + "'  group by retail_str_sales_detail.sale_date order by retail_str_sales_detail.sale_date desc");
...
//FileOutputStream fileOut = new FileOutputStream("/home/rspl-laxmeechandola/NetBeansProjects/99AR_dashdb/web/PDF/Report.xls");
                ...
                //out.println(second);
                        ...
                        Connection con1 = DriverManager.getConnection("jdbc:db2://awh-yp-small03.services.dal.bluemix.net:50000/BLUDB:user=dash107813;password=MxX8ewhhVg7f;");
                        Statement stm = con1.createStatement();
                        ResultSet RS = stm.executeQuery("select retail_str_sales_detail.sale_date,round(sum(retail_str_sales_detail.total),2) from retail_dstr_prod,retail_str_sales_detail where retail_dstr_prod.prod_id=retail_str_sales_detail.prod_id and retail_str_sales_detail.store_id='" + EStid + "'  and  retail_str_sales_detail.SALE_DATE like current_date group by retail_str_sales_detail.sale_date order by retail_str_sales_detail.sale_date desc");
                %>
                <table style="white-space: nowrap;" border="1" align="center" id="tablepaging">
                    <tr class="even">
                        <th >Sales Date</th>
...
%>
                ...
                //out.println(second);
                        ...
                        Connection con1 = DriverManager.getConnection("jdbc:db2://awh-yp-small03.services.dal.bluemix.net:50000/BLUDB:user=dash107813;password=MxX8ewhhVg7f;");
                        Statement stm = con1.createStatement();
                        ResultSet RS = stm.executeQuery("select retail_str_sales_detail.sale_date,round(sum(retail_str_sales_detail.total),2) from retail_dstr_prod,retail_str_sales_detail where retail_dstr_prod.prod_id=retail_str_sales_detail.prod_id and retail_str_sales_detail.store_id='" + EStid + "'  and  retail_str_sales_detail.SALE_DATE Between ( current_date + 1 days - day(current_date) days )and(select current_date from sysibm.sysdummy1) group by retail_str_sales_detail.sale_date order by retail_str_sales_detail.sale_date desc");
                %>
                <table style="white-space: nowrap;" border="1" align="center" id="tablepaging">
                    <tr class="even">
                        <th >Sales Date</th>
                    ...
                    <tr class="odd">
                        ...
                        //out.println(abc);
                            ...
                            try {
                                ...
                                Connection con2 = DriverManager.getConnection("jdbc:db2://awh-yp-small03.services.dal.bluemix.net:50000/BLUDB:user=dash107813;password=MxX8ewhhVg7f;");
                                Statement stmt = con2.createStatement();
                                ResultSet RS2 = stmt.executeQuery("select retail_str_sales_detail.sale_date,round(sum(retail_str_sales_detail.total),2) from retail_dstr_prod,retail_str_sales_detail where retail_dstr_prod.prod_id=retail_str_sales_detail.prod_id and retail_str_sales_detail.store_id='" + EStid + "' and  SALE_DATE Between ( current_date + 1 days - day(current_date) days )and(select current_date from sysibm.sysdummy1) group by retail_str_sales_detail.sale_date order by retail_str_sales_detail.sale_date desc");
                                while (RS2.next()) {
                                    a[i] = RS2.getString(2);
                                    i++;
                                }
...
//        FileOutputStream fileOut = new FileOutputStream("/home/rspl-laxmeechandola/NetBeansProjects/99AR_dashdb/web/PDF/Report.xls");
                ...
                <%
                    try {
                        ...
                        Connection con1 = DriverManager.getConnection("jdbc:db2://awh-yp-small03.services.dal.bluemix.net:50000/BLUDB:user=dash107813;password=MxX8ewhhVg7f;");
                        Statement stm = con1.createStatement();
                        ResultSet RS = stm.executeQuery("select retail_str_sales_detail.sale_date,round(sum(retail_str_sales_detail.total),2) from retail_dstr_prod,retail_str_sales_detail where retail_dstr_prod.prod_id=retail_str_sales_detail.prod_id and retail_str_sales_detail.store_id='" + EStid + "' and  SALE_DATE Between ( current_date + 1 days - day(current_date) days - 1 MONTH ) and ( current date - DAY(CURRENT_DATE ))   group by retail_str_sales_detail.sale_date order by retail_str_sales_detail.sale_date desc");
                %>
                <table style="white-space: nowrap;" border="1" align="center" id="tablepaging">
                    <tr class="even">
                        <th >Sales Date</th>
                    ...
                    <tr class="odd">
                        ...
                        //out.println(abc);
                            ...
                            try {
                                ...
                                Connection con2 = DriverManager.getConnection("jdbc:db2://awh-yp-small03.services.dal.bluemix.net:50000/BLUDB:user=dash107813;password=MxX8ewhhVg7f;");
                                Statement stmt = con2.createStatement();
                                ResultSet RS2 = stmt.executeQuery("select retail_str_sales_detail.sale_date,round(sum(retail_str_sales_detail.total),2) from retail_dstr_prod,retail_str_sales_detail where retail_dstr_prod.prod_id=retail_str_sales_detail.prod_id and retail_str_sales_detail.store_id='" + EStid + "' and  retail_str_sales_detail.SALE_DATE Between ( current_date + 1 days - day(current_date) days - 1 MONTH ) and ( current date - DAY(CURRENT_DATE ))   group by retail_str_sales_detail.sale_date order by retail_str_sales_detail.sale_date desc");
                                while (RS2.next()) {
                                    a[i] = RS2.getString(2);
                                    i++;
                                }
 ...
 %>
                    ...
                    <%
                            ...
                            ResultSet RS1 = stm.executeQuery("select retail_str_sales_detail.sale_date,round(sum(retail_str_sales_detail.total),2) from retail_dstr_prod,retail_str_sales_detail where retail_dstr_prod.prod_id=retail_str_sales_detail.prod_id and retail_str_sales_detail.store_id='" + EStid + "'  and  retail_str_sales_detail.SALE_DATE Between ( current_date + 1 days - day(current_date) days - 1 MONTH )and(current date + 1 month - day(current date + 1 month) days - 1 month)  group by retail_str_sales_detail.sale_date order by retail_str_sales_detail.sale_date desc");
                            HSSFWorkbook workbook = new HSSFWorkbook();
                            HSSFSheet sheet = workbook.createSheet("New Sheet");
                            HSSFRow row = sheet.createRow((short) 0);
                            HSSFFont font = workbook.createFont();
                ...
                <%
                    try {
                        ...
                        Connection con1 = DriverManager.getConnection("jdbc:db2://awh-yp-small03.services.dal.bluemix.net:50000/BLUDB:user=dash107813;password=MxX8ewhhVg7f;");
                        Statement stm = con1.createStatement();
                        ResultSet RS = stm.executeQuery("select retail_str_sales_detail.sale_date,round(sum(retail_str_sales_detail.total),2) from retail_dstr_prod,retail_str_sales_detail where retail_dstr_prod.prod_id=retail_str_sales_detail.prod_id and retail_str_sales_detail.store_id='" + EStid + "'  and  retail_str_sales_detail.SALE_DATE Between   (  current_date  - 60 DAYS  )  and(current_date ) group by retail_str_sales_detail.sale_date order by retail_str_sales_detail.sale_date desc");
                %>
                <table style="white-space: nowrap;" border="1" align="center" id="tablepaging">
                    <tr class="even">
                        <th >Sales Date</th>
                    ...
                    <tr class="odd">
                        ...
                        //out.println(abc);
                            ...
                            try {
                                ...
                                Connection con2 = DriverManager.getConnection("jdbc:db2://awh-yp-small03.services.dal.bluemix.net:50000/BLUDB:user=dash107813;password=MxX8ewhhVg7f;");
                                Statement stmt = con2.createStatement();
                                ResultSet RS2 = stmt.executeQuery("select retail_str_sales_detail.sale_date,round(sum(retail_str_sales_detail.total),2) from retail_dstr_prod,retail_str_sales_detail where retail_dstr_prod.prod_id=retail_str_sales_detail.prod_id and retail_str_sales_detail.store_id='" + EStid + "' and  SALE_DATE Between   (  current_date  - 60 DAYS  )  and(current_date ) group by retail_str_sales_detail.sale_date order by retail_str_sales_detail.sale_date desc");
                                while (RS2.next()) {
                                    a[i] = RS2.getString(2);
                                    i++;
                                }
  ...
  <center><div style="color: Indigo;"><h3><u><b><% out.println("Data for Past 60 Days");  %></u></b></h3></div>
                ...
                //out.println(second);
                        ...
                        Connection con1 = DriverManager.getConnection("jdbc:db2://awh-yp-small03.services.dal.bluemix.net:50000/BLUDB:user=dash107813;password=MxX8ewhhVg7f;");
                        Statement stm = con1.createStatement();
                        ResultSet RS = stm.executeQuery("select retail_str_sales_detail.sale_date,round(sum(retail_str_sales_detail.total),2) from retail_dstr_prod,retail_str_sales_detail where retail_dstr_prod.prod_id=retail_str_sales_detail.prod_id and retail_str_sales_detail.store_id='" + EStid + "' and  SALE_DATE like current_date group by retail_str_sales_detail.sale_date order by retail_str_sales_detail.sale_date desc");
                %>
                <table style="white-space: nowrap;" border="1" align="center" id="tablepaging">
                    <tr class="even">
                        <th >Sales Date</th>
