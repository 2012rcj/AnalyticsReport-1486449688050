...
<title>Sales Report Daily </title>
...
String V_Strnm = (String)session.getAttribute("efg"); // Contains Store Name
session.setAttribute("strnm",V_Strnm);	
   // out.println(EStid);
   // out.println(V_Strnm);
if((EStid !=null))
{
...
ResultSet RS = stm.executeQuery("select Sale_date,round(sum(total),2) from retail_str_sales_detail where Store_id ="+EStid+" group by Sale_date");
%>
<table align="right">
		<tr>
		<td>
...
<tr class="even">
   ...
   <!-- <th >Hemas Sales &nbsp(In LKR)</th>
   <th >Market Share &nbsp(In %)</th> -->
  </tr>
  <%
...
<td align="left"><a href="Piersons_SalesReportDetail.jsp?Value1='<%=(RS.getString(1))%>' "style="color:#00FFF" style="text-decoration: none" ><%=(RS.getString(1))%></a></td>
...
<td align="right"><fmt:formatNumber type="number"  minFractionDigits="2" maxFractionDigits="2"  groupingUsed="true" value="<%=(((Float.parseFloat(RS.getString(4)))*100)/(Float.parseFloat(RS.getString(3))))%>"/></td> --%>
</tr>
<%
