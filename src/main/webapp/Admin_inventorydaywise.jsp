...
Connection con1 = DriverManager.getConnection("jdbc:db2://awh-yp-small03.services.dal.bluemix.net:50000/BLUDB:user=dash107813;password=MxX8ewhhVg7f;");
Statement stm = con1.createStatement();
ResultSet RS = stm.executeQuery("select prod_nm,batch_no,inventory_date,con_mul_qty,p_price,amount from retail_str_stock_master where store_id = '"+EStid+"' order by prod_nm,inventory_date desc");
%>
<table align="right">
		<tr>
		<td>
...
float[] columnWidths = new float[] {40f, 40f, 40f,40f,40f,40f};
...
FileOutputStream fileOut = new FileOutputStream("PDF/Report.xls");
    ResultSet RS1 = stm.executeQuery("select prod_nm,batch_no,inventory_date,con_mul_qty,p_price,amount from retail_str_stock_master where store_id = '"+EStid+"' order by prod_nm,inventory_date desc");
HSSFWorkbook workbook = new HSSFWorkbook();
    ...
    cell2.setCellValue("Batch No");
    
    HSSFCell cell3 = row.createCell((short) 2);
    cell3.setCellType(HSSFCell.CELL_TYPE_STRING);
    cell3.setCellValue("Inventory Date");
    ...
    cell5.setCellValue("Purchase Price");
    
    HSSFCell cell6 = row.createCell((short) 5);
    cell6.setCellType(HSSFCell.CELL_TYPE_NUMERIC);
    cell6.setCellValue("Total Value  (In LKR)");
   int b =1;
   {
  while(RS1.next()){
...
//email.addAttachment("Abhi.pdf", new File("/home/abhinav/workspace/99AR_dashdb/WebContent/PDF/Report.pdf"));
