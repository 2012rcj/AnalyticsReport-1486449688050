...
<body>
<form action="Admin_datewisebill.jsp" method="post" id="myForm">
...
<td align="left"><a href="Admin_Billwisetotalsale.jsp?Value1='<%=(RS.getString(1))%>' "style="color:#00FFF" style="text-decoration: none" ><%=(RS.getString(1))%></a></td>
