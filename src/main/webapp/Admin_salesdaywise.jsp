...
if((EStid !=null))
{
	try{
		...
		Connection con1 = DriverManager.getConnection("jdbc:db2://awh-yp-small03.services.dal.bluemix.net:50000/BLUDB:user=dash107813;password=MxX8ewhhVg7f;");
		Statement stm = con1.createStatement();
ResultSet RS = stm.executeQuery(" select retail_str_sales_detail.tri_id, retail_str_sales_detail.prod_nm,retail_str_sales_detail.qty,retail_str_sales_detail.MRP,retail_str_sales_detail.total,retail_store_prod.th_class_1,retail_store_prod.th_class_2,retail_store_prod.th_class_3,retail_store_prod.th_class_4,retail_store_prod.mfg from retail_str_sales_detail, retail_store_prod where  retail_store_prod.prod_nm= retail_str_sales_detail.prod_nm and retail_store_prod.store_id= retail_str_sales_detail.store_id and retail_str_sales_detail.store_id='"+EStid+"' and retail_str_sales_detail.sale_date= "+V_saledate+" order by tri_id asc ");
%>
<table align="right">
		<tr>
		<td>
...
float[] columnWidths = new float[] {40f, 40f, 40f,40f,40f,40f,40f,40f,40f,40f};
...
<TD align="right"><fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" groupingUsed="true" value="<%=(RS.getString(4)) %>" /></td>
...
try{
		...
		Statement stmt = con2.createStatement();
                ResultSet RS1 = stm.executeQuery(" select retail_str_sales_detail.tri_id, retail_str_sales_detail.prod_nm,retail_str_sales_detail.qty,retail_str_sales_detail.MRP,retail_str_sales_detail.total,retail_store_prod.th_class_1,retail_store_prod.th_class_2,retail_store_prod.th_class_3,retail_store_prod.th_class_4,retail_store_prod.mfg from retail_str_sales_detail, retail_store_prod where  retail_store_prod.prod_nm= retail_str_sales_detail.prod_nm and retail_store_prod.store_id= retail_str_sales_detail.store_id and retail_str_sales_detail.store_id='"+EStid+"' and retail_str_sales_detail.sale_date= "+V_saledate+" order by tri_id asc ");
