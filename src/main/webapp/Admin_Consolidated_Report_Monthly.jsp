...
<title>Consolidated Report Monthly</title>
</head>
				...
				try {
					...
					ResultSet RS = stm.executeQuery(
							"select prod_nm,prod_id,qty,(round(total,2)) from retail_str_sales_detail where store_id='"
									+ EStid
									+ "' and sale_date Between ((select current_date from sysibm.sysdummy1)-30) and  (select current_date from sysibm.sysdummy1)");
		%>
		<table align="right">
			<tr>
				<td>
