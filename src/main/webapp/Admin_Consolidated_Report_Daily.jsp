...
<title>Consolidated Report Daily</title>
</head>
			...
			if ((EStid != null)) {
				try {
					...
					ResultSet RS = stm.executeQuery(
							"select prod_nm,prod_id,qty, round(total,2), extract(day from retail_str_sales_detail.sale_date) from retail_str_sales_detail where store_id='"
									+ EStid + "' and sale_date=(select current_date from sysibm.sysdummy1)");
		%>
		<table align="right">
			<tr>
				<td>
